...
Sou desenvolvedor web full stack com foco na construção de aplicações modernas e completas.  
Atuo tanto no front-end quanto no back-end, aplicando boas práticas, organização de código, versionamento com Git e desenvolvimento de soluções escaláveis seguindo padrões de mercado.
